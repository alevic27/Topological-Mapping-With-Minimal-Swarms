...
LABYRINTH_CONFIG = {
    Labyrinth.DOUBLE_T: {
        ...
        "polygon": Polygon([(3.0, 1.0), (1.0, 1.0), (1.0, 3.1), (2.9, 3.1), (2.9 , 5.1),(-2.9 , 5.1),(-2.9 , 3.1),
                                (-1, 3.1), (-1, -3.1),(-2.9, -3.1),(-2.9, -5.1),(2.9, -5.1),
    ...
    Labyrinth.DOUBLE_T_V2: {
        ...
        "polygon": Polygon([(6.0, 1.0), (1.0, 1.0), (1.0, 8.0), (5.8, 8.0), (5.8, 10), (-5.8, 10), (-5.8, 8.0),
                                (-1.0, 8.0), (-1.0, -8.0), (-5.8, -8.0), (-5.8, -10), (5.8, -10), (5.8, -8.0),
